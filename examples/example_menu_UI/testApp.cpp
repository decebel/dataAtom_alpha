...
{
	std::cout<<"(w,h)"<<ofGetWidth()<<","<<ofGetHeight()<<std::endl;
...
void testApp::keyPressed(int key)
{
	...
	{			
		...
		case '5':
			//gui4->mouseDragged(555,521,0);
			
			gui4->onHitExternally(400, 500, true, 0);
			//gui4->onHitExternally(360, 500, 0);
			//gui4->onHitExternally(300, 500, 0);
			break;
		case '6':
			//gui4->mouseDragged(555,521,0);
			gui4->onHitExternally(400, 500, false, 0);
			//gui4->onHitExternally(360, 500, 0);
			//gui4->onHitExternally(300, 500, 0);
			break;	
		default:
...
{	
	...
	gui4 = new ofxUIScrollableCanvas(-length, ofGetHeight()/4, length+xInit, ofGetHeight()/3);
	gui4->setSnapping(false);
    gui4->addWidgetDown(new ofxUILabel("PANEL 4: SCROLLABLE", OFX_UI_FONT_LARGE)); 	
	gui4->setScrollableDirections(true, false);
	gui4->set_hitExternallyActivated(true);

	gui5 = new ofxUIScrollableCanvas(length, ofGetHeight()/5, dim*4.0, dim*4.0);     
	gui5->setScrollableDirections(true, false);
	
	//gui4->setScrollAreaToScreenWidth();
	// set draw padding does not work
	gui4->setDrawPadding(false);
	gui4->setDrawWidgetPadding(false);
    
	gui4->addSpacer(length-xInit, 2);

	//Working - good for debugging only
	gui4->setDrawOutline(true);
	gui4->setColorOutline(ofColor(255, 0, 0, 100));
    ...
    gui4->addWidgetDown(new ofxUILabel("IMAGE TOGGLE", OFX_UI_FONT_MEDIUM)); 				        
    gui4->addWidgetDown(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/Preview.png","IMAGETGL")); 
	gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/App.png","IMAGETGL")); 
	gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/Preview.png","IMAGETGL"));
	...
	gui4->addWidget(new ofxUIImageToggle(length, ofGetHeight()/5, dim*4.0, dim*4.0, true, "GUI/play.png","IMAGETGL"));

    gui4->addWidgetDown(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/Preview.png","IMAGETGL")); 
	gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/App.png","IMAGETGL")); 
	gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/images/Preview.png","IMAGETGL"));
	
	//gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/play.png","IMAGETGL")); 
	//gui4->addWidgetRight(new ofxUIImageToggle(dim*4.0, dim*4.0, true, "GUI/toggledown.png","IMAGETGL"));
