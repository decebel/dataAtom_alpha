#ifndef OFXUI_AUTOCOMPLETEPANEL_H1
#define OFXUI_AUTOCOMPLETEPANEL_H1
...
//    }    
    ...
    {
		_sptextInput.reset(new ofxUITextInput(_name, "textstring", w, 0, x, y, _size));
		...
		_sptextInput->setRectParent(rect);
        size = _size; 
		...
		//parent->addWidget(_sptextInput.get());
